...
export function MovieUpcoming()
{
    ...
    function LoadMovies()
    {
        axios.get(`https://api.themoviedb.org/3/movie/upcoming?api_key=c45a857c193f6302f2b5061c3b85e743&page=${page}`)
        .then((response)=> {
            setMovies(response.data.results);
        });

        axios.get(`https://api.themoviedb.org/3/movie/upcoming?api_key=c45a857c193f6302f2b5061c3b85e743`)
        .then((response)=> {
